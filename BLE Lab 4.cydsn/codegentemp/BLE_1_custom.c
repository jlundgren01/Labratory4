...
const CYBLE_CUSTOMS_T cyBle_customs[0x02u] = {
    ...
    {
        0x000Eu, /* Handle of the CapSense Service service */ 
        {

            /* CapSense Slider Characteristic characteristic */
            {
                0x0010u, /* Handle of the CapSense Slider Characteristic characteristic */ 
    ...
    {
        0x0013u, /* Handle of the RGB LED Service service */ 
        {

            /* RGB LED Characteristic characteristic */
            {
                0x0015u, /* Handle of the RGB LED Characteristic characteristic */ 

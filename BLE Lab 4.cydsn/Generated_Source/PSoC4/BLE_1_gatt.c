    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x3Cu] = {
    /* Device Name */
    ...
    (uint8)'C', (uint8)'a', (uint8)'p', (uint8)' ', (uint8)'S', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'e', (uint8)' ',
(uint8)'S', (uint8)'l', (uint8)'i', (uint8)'d', (uint8)'e', (uint8)'r', 
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[19] }, /* Central Address Resolution */
    { 0x0004u, (void *)&cyBle_attValues[20] }, /* Service Changed */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0001u, (void *)&cyBle_attValues[24] }, /* CapSense Slider Characteristic */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cyBle_attValues[25] }, /* Characteristic User Description */
    { 0x0004u, (void *)&cyBle_attValues[41] }, /* RGB LED Characteristic */
    { 0x000Fu, (void *)&cyBle_attValues[45] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x16u] = {
    ...
    { 0x000Eu, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0012u, {{0xCAB5u, NULL}}                           },
    { 0x000Fu, 0x2803u /* Characteristic                      */, 0x00001001u /* ntf   */, 0x0012u, {{0xCAA2u, NULL}}                           },
    { 0x0010u, 0xCAA2u /* CapSense Slider Characteristic      */, 0x00011000u /* ntf   */, 0x0012u, {{0x0001u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x0011u, 0x2902u /* Client Characteristic Configuration */, 0x00010A04u /* rd,wr */, 0x0011u, {{0x0002u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0012u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd    */, 0x0012u, {{0x0010u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0013u, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0016u, {{0xCBBBu, NULL}}                           },
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr */, 0x0016u, {{0xCBB1u, NULL}}                           },
    { 0x0015u, 0xCBB1u /* RGB LED Characteristic              */, 0x00010A04u /* rd,wr */, 0x0016u, {{0x0004u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0016u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd    */, 0x0016u, {{0x000Fu, (void *)&cyBle_attValuesLen[10]}} },
};
